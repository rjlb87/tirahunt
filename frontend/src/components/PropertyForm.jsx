    ...
    <div className="max-w-6xl mx-auto bg-black rounded-lg shadow-lg">
      {!showForm && (
        <div className="fixed inset-0 z-50 flex flex-col justify-center items-center overflow-auto bg-opacity-75">
          <div className="bg-gray-100 max-w-lg py-4 rounded-lg">
            <div className="relative">
              <h2 className="text-2xl font-bold uppercase mb-10 text-[#92c872] border-b w-full flex justify-center pb-3">
                Properties
              </h2>
              <button
                onClick={handleShow}
                className="absolute top-0 right-0 p-2 mr-2"
              >
                <AiOutlineClose />
              </button>
            </div>
            <form onSubmit={handleSubmit}>
              ...
              <div className="text-center px-6">
                <button
                  type="submit"
                  className="px-4 py-2 w-full  text-white rounded bg-[#92c872]  hover:bg-[#77af57] focus:outline-none focus:ring focus:ring-blue-200"
                >
                  Submit
                </button>
              </div>
